...
public class DataSetRunBean implements Serializable {
	...
	/**
	 * @param featureForDataSetRunBeansList
	 *            the featureForDataSetRunBeansList to set
	 */
	...
	/**
	 * @param readyForReExecute
	 *            the readyForReExecute to set
	 */
	...
	/**
	 * @param styleClassForDataSetStatus
	 *            the styleClassForDataSetStatus to set
	 */
